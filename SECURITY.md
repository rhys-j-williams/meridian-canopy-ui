# Application security standard — Canopy design system

Owner: @northgate/canopy-design-system. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@northgate.internal`) with the component name `canopy-ui` and, if the finding came
