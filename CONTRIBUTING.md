...
Feature branches are `feature/CNPY-1234-short-description`. Also permitted: `bugfix/`, `hotfix/`,
`spike/`, `chore/`. The pre-commit hook rejects anything else.

## Commits

`CNPY-1234 imperative summary`, 72 characters or fewer, with an optional body explaining why. The
