...
ng add @northgate/canopy-ui</pre>
      ...
      <cn-card title="Import per family" subtitle="Keeps the consumer bundle honest">
        <pre class="cs-code">import {{ '{' }} CnDataTableModule {{ '}' }} from '@northgate/canopy-ui/data-display';
import {{ '{' }} CnCurrencyInputModule {{ '}' }} from '@northgate/canopy-ui/forms';</pre>
      ...
      <cn-card title="Theme" subtitle="One mixin, three variants">
        <pre class="cs-code">@use '@northgate/canopy-ui/themes' as canopy;
